...
class ReduceOptimizer:
    ...
    def should_optimize_helper(
        ...
        model = op_config.get("model", self.config.get("default_model", "azure/gpt-4o-mini"))
    ...
    def _optimize_decomposed_reduce(
        ...
        if first_reduce_config.get("synthesize_resolve", True):
            resolve_config = {
                ...
                "resolution_model": self.config.get("default_model", "azure/gpt-4o-mini"),
                "comparison_model": self.config.get("default_model", "azure/gpt-4o-mini"),
                "_intermediates": {
    ...
    def _create_reduce_plans(
        ...
        """
        model = op_config.get("model", "azure/gpt-4o-mini")
        model_input_context_length = model_cost.get(model, {}).get(
