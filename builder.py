...
class Optimizer:
    ...
    def __init__(
        ...
        Args:
            ...
            model (str): The name of the language model to use. Defaults to "azure/gpt-4o".
        ...
        for operation_config in self.config["operations"]:
            ...
            try:
                ...
                operation_class(
                    self.runner,
                    operation_config,
                    self.config.get("default_model", "azure/gpt-4o-mini"),
                    self.max_threads,
    ...
    def _optimize_equijoin(
        ...
        for _ in range(max_iterations):
            ...
            map_operation = {
                ...
                "type": "map",
                "prompt": map_prompt,
                "model": self.config.get("default_model", "azure/gpt-4o-mini"),
...
if __name__ == "__main__":
    optimizer = Optimizer("workloads/medical/map.yaml", model="azure/gpt-4o-mini")
    optimizer.optimize()
